...
Both cell classes inherit certain parameters from the BaseCell class.
...
Tumour cells have a 10% chance of proliferating each step the model takes, with a further 15% chance of mutating their graded level of peptide-HLA. Mutations are set to change +/- level of peptide (from 1-9). These can also be adjusted to fit different cell-line characteristics. 
